  ...
  <div class="d-flex flex-row">
        ...
        <div class="card-body pt-8">
          <div class="d-flex align-items-center mb-8">
            <div class="symbol symbol-60 symbol-xxl-100 mr-5 align-self-start align-self-xxl-center">
              <div class="symbol-label" style="background-image:url('{{ setImage($user->profile_photo_path) }}')"></div>
          ...
          <div class="navi navi-bold navi-hover navi-active navi-link-rounded">
            <div class="navi-item mb-2">
              <a href="{{ route('edit.profile') }}" class="navi-link py-4 active">
            ...
            <div class="navi-item mb-2">
              <a href="{{ route('change_password') }}" class="navi-link py-4">
                <span class="navi-icon mr-2">
                  <span class="svg-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                      <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
    ...
    <div class="flex-row-fluid ml-lg-8">
      <div class="card card-custom card-stretch">
        ...
        <form class="form" action="{{ route('user-profile-information.update') }}" id="profile_update_form" method="post" enctype="multipart/form-data">
          @csrf
          @method('PUT')
          <div class="card-body">
            <div class="row">
            ...
            <div class="form-group row">
              ...
              <div class="col-lg-9 col-xl-6">
                <div class="image-input image-input-outline image-input-circle" id="kt_image_4">
                  <div class="image-input-wrapper" style="width: 120px; background-position: center; background-image: url({{ setImage($user->profile_photo_path) }})"></div>
